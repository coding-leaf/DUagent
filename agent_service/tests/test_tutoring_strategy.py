...
def test_rule_strategy_maps_l1_to_guided_hint() -> None:
    strategy = select_tutoring_strategy_by_rule(_make_request("L1"), _make_context())
...
def test_rule_strategy_maps_l2_to_worked_example() -> None:
    strategy = select_tutoring_strategy_by_rule(_make_request("L2"), _make_context())
...
def test_rule_strategy_maps_l3_to_direct_explanation() -> None:
    strategy = select_tutoring_strategy_by_rule(_make_request("L3"), _make_context())
...
def test_rule_strategy_uses_clarifying_question_for_short_ambiguous_message() -> None:
    strategy = select_tutoring_strategy_by_rule(_make_request("L3", message="这个"), _make_context())
