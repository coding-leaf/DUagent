...
class TestMapAssessmentToStatus:
    ...
    def test_learning_maps_to_in_progress(self):
        assert map_assessment_to_status("learning") == "in_progress"

    def test_weak_maps_to_recommended(self):
        assert map_assessment_to_status("weak") == "recommended"

    def test_pending_practice_maps_to_pending(self):
        assert map_assessment_to_status("pending_practice") == "pending"

    def test_unstarted_maps_to_pending(self):
        assert map_assessment_to_status("unstarted") == "pending"

    def test_unknown_state_maps_to_pending(self):
        assert map_assessment_to_status("something_else") == "pending"
