...
> **完整的请求体/响应体格式见 `../10-client-api/API_前端接口规范.md` 和 `../20-agent-api/API_Agent内部接口规范.md`。**
...
> 完整的请求体/响应体见 [`API_Agent内部接口规范.md`](../20-agent-api/API_Agent内部接口规范.md) 和 [`Agent-Service.openapi.json`](../20-agent-api/Agent-Service.openapi.json)
