# Learning Path Refactoring Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Dismantle the massive `LearningPath.jsx` into modular Container/Presentational components and extract data fetching/tracking to a Custom Hook.

**Architecture:** 
- `useLearningPath.js`: SWR-based hook for path data and node resources.
- `PathVisualizer.jsx`: Presentational component for the horizontal path graph.
- `NodeResourcePanel.jsx`: Presentational component for the node resources.
- `LearningPath.jsx`: Container orchestrator.

**Tech Stack:** React, SWR

---

### Task 1: Create `useLearningPath` Custom Hook

**Files:**
- Create: `src/hooks/useLearningPath.js`

- [ ] **Step 1: Write the hook implementation**

Create `src/hooks/useLearningPath.js` with the following code:
```javascript
...
- [ ] **Step 3: Commit**
Run: `git add src/hooks/useLearningPath.js && git commit -m "feat(learning): extract useLearningPath custom hook"`

---

### Task 2: Create `PathVisualizer` Presentational Component

**Files:**
- Create: `src/components/learning/PathVisualizer.jsx`

- [ ] **Step 1: Write the component**

Extract lines 138-254 from the original `LearningPath.jsx` into this new file.

Create `src/components/learning/PathVisualizer.jsx` with:
```javascript
import { useEffect, useRef } from 'react';
...
- [ ] **Step 3: Commit**
Run: `git add src/components/learning/PathVisualizer.jsx && git commit -m "feat(learning): extract PathVisualizer component"`

---

### Task 3: Create `NodeResourcePanel` Component

**Files:**
- Create: `src/components/learning/NodeResourcePanel.jsx`

- [ ] **Step 1: Write the component**

Extract lines 256-426 from the original `LearningPath.jsx`. Move the local state hooks into this component.

Create `src/components/learning/NodeResourcePanel.jsx` with:
```javascript
...
- [ ] **Step 3: Commit**
Run: `git add src/components/learning/NodeResourcePanel.jsx && git commit -m "feat(learning): extract NodeResourcePanel component"`

---

### Task 4: Refactor `LearningPath.jsx` Container

**Files:**
- Modify: `src/pages/LearningPath.jsx`

- [ ] **Step 1: Replace contents of `src/pages/LearningPath.jsx`**
...
- [ ] **Step 2: Verify with linter and build**
Run: `npm run lint && npm run build`
Expected: PASS

- [ ] **Step 3: Commit**
Run: `git add src/pages/LearningPath.jsx && git commit -m "refactor(learning): convert LearningPath to clean Container component"`
